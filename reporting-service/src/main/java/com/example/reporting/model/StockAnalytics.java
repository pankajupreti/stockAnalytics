...
public class StockAnalytics {
    ...
    // RS (Relative Strength) Rating: 1-99 percentile rank comparing stock's performance vs all other stocks
    // Calculated using weighted average: 40% 2-month + 20% 1-month + 40% 1-year performance
    private Double rsRating;
    private LocalDateTime rsRatingUpdated;
    ...
    public LocalDateTime getRsRatingUpdated() {
        return rsRatingUpdated;
    }

    public void setRsRatingUpdated(LocalDateTime rsRatingUpdated) {
        this.rsRatingUpdated = rsRatingUpdated;
    }
}
