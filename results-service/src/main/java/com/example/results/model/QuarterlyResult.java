...
/**
 * Entity to store quarterly financial results for companies.
...
@Table(name = "quarterly_results",
       ...
       indexes = {
           @Index(name = "idx_qr_ticker", columnList = "ticker"),
           @Index(name = "idx_qr_fiscal_year", columnList = "fiscal_year"),
           @Index(name = "idx_qr_result_date", columnList = "result_date")
       })
@Data
@NoArgsConstructor
@AllArgsConstructor
